...
<head>
    ...
    <link rel="stylesheet" href="{{ url('public/vendor/themify-icons/themify-icons.css') }}">
    <link rel="stylesheet" href="{{ url('public/vendor/perfect-scrollbar/css/perfect-scrollbar.css') }}">

    <!-- CSS for this page only -->
<link rel="stylesheet" href="{{ url('public/') }}../vendor/chart.js/Chart.min.css">
    <!-- End CSS  -->

    <link rel="stylesheet" href="{{ url('public/assets/css/style.min.css') }}">
    <link rel="stylesheet" href="{{ url('public/assets/css/bootstrap-override.min.css') }}">
    <link rel="stylesheet" id="theme-color" href="{{ url('public/assets/css/dark.min.css') }}">
</head>
                ...
                <div class="header-content">
                            ...
                            <li class="menu-content ps-menu">
                                <a href="#">
                                    <div class="message-image">
                                        <img src="{{ url('public/assets/images/avatar1.png') }}" class="rounded-circle w-100" alt="user1">
                                    </div>
                                ...
                                <a href="#">
                                    <div class="message-image">
                                        <img src="{{ url('public/assets/images/avatar2.png') }}" class="rounded-circle w-100" alt="user1">
                                    </div>
                    ...
                    <div class="dropdown dropdown-menu-end">
                        <a href="#" class="user-dropdown" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <img class="img-user" src="{{ url('public/assets/images/avatar1.png') }}" alt="user"srcset="">
                        </a>
            ...
            <div class="sidebar-content">
                <ul>
                    ...
                    <li class="menu-category">
                        <span class="text-uppercase">Forms</span>
                    </li>
                    <li>
                    ...
                    <li class="menu-category">
                        <span class="text-uppercase">Tables</span>
                    </li>
                    <li>
                        <a href="#" class="main-menu has-dropdown">
                            <i class="ti-write"></i>
                        ...
                        <ul class="sub-menu ">
                            ...
                            <li><a href="table-datatables.html" class="link"><span>shopkeepers Table</span></a></li>
                            <li><a href="table-datatables.html" class="link"><span>Customers Table</span></a></li>
                            <li><a href="table-datatables.html" class="link"><span>Products Table</span></a></li>
                        </ul>
                    </li>
                            ...
                            <ol class="discussion">
                                ...
                                <li class="self">
                                    <div class="message">
                                        ...
                                        <div class="message-avatar">
                                            <img src="{{ url('public/assets/images/avatar1.png') }}" alt="">
                                        </div>
                                    </div>
                                    <div class="message">
                                        <div class="message-name">
                                ...
                                <li class="other">
                                    <div class="message">
                                        ...
                                        <div class="message-avatar">
                                            <img src="{{ url('public/assets/images/avatar2.png') }}" alt="">
                                        </div>
                                    </div>
                                </li>
                                <li class="self">
...
<script src="{{ url('public/assets/js/pages/index.min.js') }}"></script>
    <!-- ======= -->
