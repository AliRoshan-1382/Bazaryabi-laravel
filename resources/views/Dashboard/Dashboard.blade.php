            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ url('') }}">عملکرد مشتریان</a></li>
                        </ul>
                    </li>
						...
						<div class="card bg-warning invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									<span class="text-white fs-18">مشتری</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									<span class="text-white fs-18">پشتیبان</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-info invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									<span class="text-white fs-18">محصول</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-secondary invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									<span class="text-white fs-18">مغازه دار</span>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
								...
								<div class="row align-items-center">
									<div class="col-xl-6">
										<div class="card-bx bg-blue">
											<img class="pattern-img" src="{{ url('public/images/pattern/pattern6.png') }}" alt="">
											<div class="card-info text-white">
												<img src="{{ url('public/images/pattern/circle.png') }}" class="mb-4" alt="">
					...
					<div class="col-xl-3 col-xxl-7">
						<div class="card">
							...
							<div class="card-body">	
								<div class="user-bx">
									<img src="{{ url('public/images/profile/small/pic1.jpg') }}" alt="">
									<div>
								...
								<ul class="user-list">
									<li><img src="{{ url('public/images/avatar/1.jpg') }}" alt=""></li>
									<li><img src="{{ url('public/images/avatar/2.jpg') }}" alt=""></li>
									<li><img src="{{ url('public/images/avatar/3.jpg') }}" alt=""></li>
									<li><img src="{{ url('public/images/avatar/4.jpg') }}" alt=""></li>
									<li><img src="{{ url('public/images/avatar/5.jpg') }}" alt=""></li>
									<li><img src="{{ url('public/images/avatar/6.jpg') }}" alt=""></li>
								</ul>
