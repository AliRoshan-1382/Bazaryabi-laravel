				...
				<ul class="metismenu" id="menu">
                    ...
                    <li class="mm-active"><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a class="mm-active" href="{{ url('Admin/AddSupporter') }}">فرم ثبت پشتیبان</a></li>
                        </ul>
                    </li>
                                ...
                                <div class="basic-form">
                                    <form action="" method="POST">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="col-xl-4 col-xxl-6 col-6">
                                                    <div class="form-check custom-checkbox mb-3 checkbox-danger">
                                                        <input type="checkbox" name="access" id="access" class="form-check-input" checked required>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="col-xl-4 col-xxl-6 col-6">                                                           
                                                    <input type="file" name="picture" id="picture" class="form-file-input form-control">
                                                </div>
                                            </div>
                                        </div>
