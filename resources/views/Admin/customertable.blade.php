            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a class="mm-active" href="{{ url('Admin/CustomerTable') }}">مشتریان</a></li>
                    </ul>
                    </li>
                                    ...
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            @foreach ($customers as $customers)
                                                <tr>
                                                    <td><a href="javascript:void(0)" class="badge badge-{{ $color[rand(0,7 )] }}">{{ $customers->id }}</a></td>
                                                    ...
                                                    <td>{{$customers->customer_province}}</td>
                                                    <td>{{$customers->customer_shop}}</td>
                                                    <td>{{$customers->submit_time}}</td>
                                                    <td>{{$customers->submit_date}}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
